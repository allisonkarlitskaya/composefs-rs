...
blocks" stored in the composefs object store with the goal that it's possible to
...
[tar-split](https://github.com/vbatts/tar-split), with some important differences:
 ...
 - in addition to the ability to split out chunks of file content (like files
   ...
   content in the referent, which can be useful for cross-document references
